    ...
    <div className="fixed h-screen inset-0 flex z-50 text-black ">
        ...
        <div className="modal-content w-full max-w-md  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="bg-white font-roboto border border-black rounded-[10px]">
            <img src="./src/assets/close 1.svg" className="right-0 absolute p-2 scale-125 cursor-pointer" onClick={onClose}/>
            <div className="mt-8 mb-8 px-4">
                <h1 className="text-2xl px-2">
                    Adicionar Disciplinas
                </h1>
                <div className='flex gap-x-1 mt-4'>
                    <input type="text" placeholder='Insira código da disciplina' className='text-[1.2rem] border px-2 border-black rounded-lg focus:outline-none focus:ring w-full block p-2"/>' />
                </div>
            </div>
          </div>
        </div>
